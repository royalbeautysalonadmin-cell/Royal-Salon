...
export function NicheLanding({ slug }: { slug: string }) {
  ...
  const services = nicheFeaturedServices(page);
  ...
  return (
    <>
          ...
          <div className="container-luxury">
            <div className="mb-10 text-center">
              ...
              <h2 className="mt-4 font-serif text-3xl font-semibold leading-tight text-luxury-black md:text-[2.4rem]">
                Treatments you might be looking for
              </h2>
            </div>
            ...
            <div className="mt-12 flex flex-wrap justify-center gap-2">
              {page.relatedCategorySlugs.map((catSlug) => (
                ...
                >
                  All {categoryLabelFallback(catSlug)}
                </Link>
              ))}
            </div>
          </div>
      ...
      <FaqSection eyebrow={`${page.eyebrow} FAQ`} faqs={page.faqs} />
      ...
      <CtaBand
        title="Book your appointment at Royal Beauty Salon"
        description="Reserve your spot in central Warsaw. Tell us your preferences when booking and we'll make your visit perfectly comfortable."
